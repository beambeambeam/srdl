/* eslint-disable complexity, no-nested-ternary, no-shadow, no-use-before-define, prefer-destructuring */
...
import {
  ...
  FacetedList,
  FacetedTrigger,
} from "@srdl/ui/components/faceted";
...
import type { ExtendedColumnFilter, JoinOperator, FilterOperator } from "@srdl/ui/types/data-table";
