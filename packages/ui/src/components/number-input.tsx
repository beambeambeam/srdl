...
import { FieldLabel } from "@srdl/ui/components/field";
import { Input } from '@srdl/ui/components/input';
import type { InputProps } from '@srdl/ui/components/input';
...
export const NumberFieldDecrement = (
  ...
  return (
    <ArkNumberInput.DecrementTrigger className={cn(
              "relative",
              ...
              className
            )} data-slot="number-input-decrement" {...rest} render={<Button aria-label="Decrement" variant="ghost" />}><MinusIcon aria-hidden /></ArkNumberInput.DecrementTrigger>
  );
};
...
export const NumberFieldIncrement = (
  ...
  return (
    <ArkNumberInput.IncrementTrigger className={cn(
              "relative",
              "h-8 in-data-[size=lg]:h-9 in-data-[size=sm]:h-7",
              "flex shrink-0",
              "text-foreground",
              ...
              "pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11",
              className
            )} data-slot="number-input-increment" {...rest} render={<Button aria-label="Increment" variant="ghost" />}><PlusIcon aria-hidden /></ArkNumberInput.IncrementTrigger>
  );
};
...
export const NumberFieldInput = (props: React.ComponentProps<typeof Input>) => {
  ...
  return (
    <ArkNumberInput.Input data-slot="number-input-input" {...rest} render={<Input className={cn(
                "grow",
                "dark:bg-transparent",
                ...
                className
              )} size={size} />}></ArkNumberInput.Input>
  );
};
...
export const NumberFieldScrubber = (
  ...
  return (
    <ArkNumberInput.Scrubber className={cn("flex cursor-ew-resize", className)} data-slot="number-input-scrubber" {...rest} render={<ArkNumberInput.Label render={<FieldLabel />} />}>{children}</ArkNumberInput.Scrubber>
  );
};
