...
import { Separator } from "@srdl/ui/components/separator";
import { SidebarToggleIcon } from "@srdl/ui/components/sidebar-toggle-icon";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@srdl/ui/components/sheet";
import { Skeleton } from "@srdl/ui/components/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@srdl/ui/components/tooltip";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      const nextOpen = typeof value === "function" ? value(sidebarOpen) : value;
      if (setOpenProp) {
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <SidebarToggleIcon isOpen={open} className="size-4" />
